...
namespace AudioStreamDemo
{
    ...
    public class MediaSourcePlaybackDemo : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            yield return AudioStreamSupport.FileSystem.GetFilenameFromStreamingAssets(this.media_StreamingAssetsFilename, "AudioStream", (path) => this.media_StreamingAssetsFilename = path);
