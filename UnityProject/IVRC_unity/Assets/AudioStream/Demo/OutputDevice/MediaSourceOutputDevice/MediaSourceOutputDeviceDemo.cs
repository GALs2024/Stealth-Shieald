...
namespace AudioStreamDemo
{
    ...
    public class MediaSourceOutputDeviceDemo : MonoBehaviour
    {
        ...
        /// </summary>
        List<FMOD_SystemW.OUTPUT_DEVICE_INFO> availableOutputs = new List<FMOD_SystemW.OUTPUT_DEVICE_INFO>();
        /// <summary>
        ...
        IEnumerator Start()
        {
            ...
            yield return AudioStreamSupport.FileSystem.GetFilenameFromStreamingAssets(media1_Filename, "AudioStream", (path) => this.media1_StreamingAssetsFilename = path);
            yield return AudioStreamSupport.FileSystem.GetFilenameFromStreamingAssets(media2_Filename, "AudioStream", (path) => this.media2_StreamingAssetsFilename = path);
        ...
        void OnGUI()
        {
            ...
            if (this.selectedOutput != this.previousSelectedOutput
                ...
                && !string.IsNullOrWhiteSpace(this.media1_StreamingAssetsFilename)
                && !string.IsNullOrWhiteSpace(this.media2_StreamingAssetsFilename)
                )
            {
                if ((Application.isPlaying
                    ...
                    )
                {
                    ...
                    var chanCount = this.availableOutputs[this.selectedOutput].channels_driver;
            ...
            {
                var channels = Enumerable.Range(0, this.availableOutputs[this.selectedOutput].channels_driver)
