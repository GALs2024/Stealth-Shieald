    ...
    public class ResonanceSoundfieldDemo : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            */
            ...
            this.availableOutputs = FMOD_SystemW.AvailableOutputs(LogLevel.INFO, "ResonanceSoundfieldDemo", null);
            ...
            string filepath = "";
            yield return AudioStreamSupport.FileSystem.GetFilenameFromStreamingAssets("Leonard-Orfeo_Trio.wav", "AudioStream", (newDestination) => filepath = newDestination);
            ...
            using (new GUILayout.HorizontalScope())
            {
                ...
                using (new GUILayout.VerticalScope(GUILayout.MaxWidth(Screen.width / 3)))
                {
                    ...
                    if (this.selectedOutput != this.previousSelectedOutput)
                    {
                        ...
                        {
                            this.resonanceSoundfield.SetOutput(this.selectedOutput);
                        }
