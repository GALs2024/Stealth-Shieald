...
public class HandWaveDetectManager : MonoBehaviour
{
    ...
    private string pythonPath = @"__IVRC2024__/Taichi/Assets/Scripts/PythonScripts/for_unity.py";  // Pythonのパスを指定
    ...
    {
        string _pythonPath = Path.Combine(Application.dataPath, this.pythonPath);
        pythonProcess = new Process();
        pythonProcess.StartInfo.FileName = @"python";  // Pythonのパスを指定
        pythonProcess.StartInfo.Arguments = _pythonPath;  // スクリプトのパスを指定
